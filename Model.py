...
#Each hidden layer accepts the input data, processes it as per the activation function and passes it to the successive layer.
...
# In the end, the gradient is calculated for the optimization objective.
